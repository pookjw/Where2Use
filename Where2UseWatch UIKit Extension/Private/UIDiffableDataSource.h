...
@property(nonatomic,copy,nullable) NSDiffableDataSourceSectionSnapshot *(^snapshotForExpandingParentItemHandler)(ItemType, NSDiffableDataSourceSectionSnapshot *);
@end
...
- (void)applySnapshot:(NSDiffableDataSourceSectionSnapshot *)snapshot toSection:(SectionIdentifierType)sectionIdentifier animatingDifferences:(BOOL)animatingDifferences UIKIT_SWIFT_ACTOR_INDEPENDENT;
- (void)applySnapshot:(NSDiffableDataSourceSectionSnapshot *)snapshot toSection:(SectionIdentifierType)sectionIdentifier animatingDifferences:(BOOL)animatingDifferences completion:(void (^ _Nullable)(void))completion UIKIT_SWIFT_ACTOR_INDEPENDENT NS_SWIFT_DISABLE_ASYNC;
- (NSDiffableDataSourceSectionSnapshot *)snapshotForSection:(SectionIdentifierType)section UIKIT_SWIFT_ACTOR_INDEPENDENT;
